...
int writejpegheader(JPEGHEADER *jpegheader)
{
       ...
       // }
        ...
        jpegheader->sof0.ImageHeight[0] = heightbit1;
        jpegheader->sof0.ImageHeight[1] = heightbit2;
        jpegheader->sof0.ImageWidth[0] = widthbit1;
        jpegheader->sof0.ImageWidth[1] = widthbit2;
